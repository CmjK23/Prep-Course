...
function fizzBuzz(numero) {
  ...
  var b1 = numero % 3 === 0;
  var b2 = numero % 5 === 0;
  if (b1 && b2){return "fizzbuzz";}
  else {
      if (b1){return "fizz";}
      else if (b2){return "buzz";}
      else {return numero;}
  }
...
function esPrimo(numero) {
  ...
  if (numero === 0 || numero === 1){return false;}
      ...
      for (let i = 2; i < numero && b; i++){
          if (numero % i === 0){b = false;}
      }
      return b;
  }
}
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  var b = numero === Math.floor(numero) && numero > 99 && numero < 1000;
  return b; 
}
